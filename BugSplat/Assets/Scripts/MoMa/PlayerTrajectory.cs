...
public class PlayerTrajectory : GameLoop
{
    ...
    public AnimationClips AttackActionClips;
    ...
    private float _AttackTime; //assume we know... todo get it!!!
    ...
    {
        StartCoroutine(PlayOneWholeAnimation(AttackActionClips.AnimClips[animIndex]));
    }
